		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label> <label style = "color:red;">Php. 2,000.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style = "color:red;">Php. 2,400.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style = "color:red;">Php. 2,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">Php. 3,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">Php. 4,000.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
