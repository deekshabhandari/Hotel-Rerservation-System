				...
				<div class = "well col-md-4">
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
						 ...
						 <input name="firstname" id="firstname" pattern="[A-Za-z]+">
				        
						</div>
						<div class = "form-group">
							<label>Middlename:  </label><br> 
							 <input name="middlename" id="middlename" pattern="[A-Za-z]+">
						</div>
						<div class = "form-group">
							<label>Lastname:<br></label><br>
							 <input name="lastname" id="lastname" pattern="[A-Za-z]+">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input name="contactno" id="contactno" pattern="[0-9]{10}">
						</div>
						<div class = "form-group">
